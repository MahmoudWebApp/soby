...
const AboutBrand = () => {
    const { storyAboutData, isLoadingData } = useGetStoryAboutQuery<{ storyAboutData: IBrandAboutProps, isLoadingData: boolean }>(undefined, {
        selectFromResult: ({ data, isLoading }) => ({
            storyAboutData: data?.brand,
            isLoadingData: isLoading
        }),
    });
    console.log(storyAboutData);
