...
const SlideOne: React.FC<IProps> = (props) => {
    const lang=localStorage.getItem("lang")
    const [dir] = useState(localStorage.getItem("lang"));
    const classLang = dir === "ar" ? "font-almarai" : "font-roboto";
    return (
        <div
            className={`flex flex-col  items-start     mt-0  md:gap-y-5 xl:gap-y-8 sm:gap-y-3 gap-y-2 w-full  ${classLang} `}
        >
            ...
            <div className="md:-mt-6 -mt-3">
                <h2 className="lg:text-6xl sm:text-2xl text-xl text-soby-gray-blue-gray font-bold ">
                {props.title}
                </h2>
            </div>
            ...
            <div className="flex md:flex-row  md:gag-x-3 items-center gap-x-1 md:mt-0 sm:mt-5 mt-2 ">
                <Link
                ...
                >
                    ...
                    <button
                     className='rounded-3xl bg-soby-gray-blue-gray md:text-base sm:text-sm text-[10px] text-white md:px-6 px-2 md:py-2 py-1'
                ...
                >
                    <button className="md:ms-8  ms-1 flex flex-row md:gag-x-3  gap-x-1 items-center">
                        ...
                        />
                        <span className=" md:ms-3 ms-1 md:text-base sm:text-xs text-[10px] font-semibold text-soby-dark-1">
